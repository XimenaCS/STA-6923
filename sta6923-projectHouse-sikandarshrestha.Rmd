...
## 3.3 Plotting for `Price` by `Area`, `Bedrooms`, `Bathrooms`, `Floors`, `YearBuiltBin` using ggplot( Grammer of Graphics plot) 
...
library(ggplot2)
 b1 <- ggplot(house, aes_string(x = 'YearBuiltBin', y = 'Price')) +
        geom_boxplot(fill = "skyblue") +
        ggtitle("Bar Plot YearBuilt vs Price (Mean)") +
        theme_minimal()
b1
```
...
library(ggplot2)
 b2 <- ggplot(house, aes_string(x = 'Location', y = 'Price')) +
        geom_boxplot(fill = "skyblue") +
        ggtitle("Bar Plot Location vs Price (Mean)") +
        theme_minimal()
b2
```
...
#Price vs. YearBuiltBin
 b3 <- ggplot(house, aes_string(x = 'Condition', y = 'Price')) +
        geom_boxplot(fill = "skyblue") +
        ggtitle("Bar Plot Condition vs Price (Mean)") +
        theme_minimal()
b3
```
...
```{r}
 b2 <- ggplot(house, aes_string(x = 'Garage', y = 'Price')) +
        geom_boxplot(fill = "skyblue") +
        ggtitle("Bar Plot Garage vs Price (Mean)") +
        theme_minimal()
b2
```

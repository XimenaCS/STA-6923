...
You should always include the link or appropriate reference for your data source.

The histogram should be the one you used to visualize the price. How can the price appear to have no association with Area or other variables? If your goal is to predict the price using this dataset, you need to demonstrate at least some potential relationships among the variables.

Please review your data and make any necessary changes as soon as possible.
...
+------------+---------+--------------------------------------------------------------------------------------------------------------------------+
| Variable   | p-value | Interpretation with significance level 5%                                                                                |
+============+=========+==========================================================================================================================+
| Floors     | 0.0114  | Statistically significant predictor variable `Floors` with house `Price` . That means, more floors implies higher price. |
+------------+---------+--------------------------------------------------------------------------------------------------------------------------+
| All others | \>0.05  | Not statistically significant in this model `model_lm_full`                                                              |
+------------+---------+--------------------------------------------------------------------------------------------------------------------------+

**Conclusion:**

In this model `model_lm_full` , the number of floors is the only strong predictor of `Price` using a simple linear multiple regression model.

Also, R2 =0.01069, implies the model explains only about 1.07% of price variation. This indicates that the relationship is not linear or some important predictors are missing (eg lot size, neighborhood rating, renovations e.t.c.)
...
+=====================+===========+============================================================================================================================================================+
| R2                  | 0.01186   | The model explains only about 1.19% of price variation.                                                                                                    |
+---------------------+-----------+------------------------------------------------------------------------------------------------------------------------------------------------------------+
| Adjusted R2         | 0.0008615 | After adjusting for the number of predictors, the model explains about 0.09% of price variation.                                                           |
+---------------------+-----------+------------------------------------------------------------------------------------------------------------------------------------------------------------+
| F-statistic p-value | 0.3631    | Overall the model is not statistically significant. That means, predictors are not affects the response.                                                   |
+---------------------+-----------+------------------------------------------------------------------------------------------------------------------------------------------------------------+
